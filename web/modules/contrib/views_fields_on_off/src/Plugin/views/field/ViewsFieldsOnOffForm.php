...
class ViewsFieldsOnOffForm extends FieldPluginBase {
  ...
  protected function defineOptions() {
    ...
    $options['fields_default_state'] = ['default' => []];
  ...
  public function buildOptionsForm(&$form, FormStateInterface $form_state) {
    ...
    // foreach ($all_fields as $key => $field) {
      // TODO: Hastily disabled this helpful check in order to share progress on
      // https://www.drupal.org/project/views_fields_on_off/issues/3032517
      // where it is important to _not_ exclude hidden fields from this cool
      // widget.
    ...
    $form['fields_default_state'] = [
      '#type' => 'checkboxes',
      '#title' => $this->t('Field\'s Default State'),
      '#description' => $this->t('Choose the default state for the field. Check to keep On by default. If unchecked it will be Off/hidden from display.'),
      '#options' => $field_options,
      '#default_value' => $this->options['fields_default_state'],
    ];
